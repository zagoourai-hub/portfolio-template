# CLAUDE.md - Zagoour Standards [profile: nextjs-fullstack]

Konstitusi project untuk Claude Code. File ini harus selalu mengikuti profile installer yang dipilih.
File pasangan: `AGENTS.md`. Detail implementasi ada di skill terpasang: `loop-engineering, security, security-audit, git-workflow, debug, api-docs, ci-cd, analyze-prd, analyze-code, execute-prd, test-fix-loop, frontend-fullstack, schema, testing, test-live, ui-clone, docker`.
...
> Untuk file pasangan, salin/symlink isi ini sebagai `AGENTS.md` bila perlu.
